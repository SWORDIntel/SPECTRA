...
sidebar_position: 2
description: Get SPECTRA running in 30 seconds with the professional auto-launching system
...
# With desktop shortcuts (if supported):
...
- **Comprehensive Guide**: See [Launcher Guide](../guides/launcher.md)
- **Project Documentation**: See [README](../../README.md)
