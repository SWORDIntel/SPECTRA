...
def show_status_summary(checks: dict):
    ...
    if all_good:
        ...
        print(f"{Colors.YELLOW}⚠  Setup required. Run: python3 spectra-launch.py --setup{Colors.NC}")
...
def show_quick_help():
    ...
    commands = [
        ("Launch TUI", "python3 spectra-launch.py"),
        ("Setup wizard", "python3 spectra-launch.py --setup"),
        ("CLI commands", "python3 spectra-launch.py --cli"),
        ("System check", "python3 spectra-launch.py --check"),
        ("Repair install", "python3 spectra-launch.py --repair")
    ]
