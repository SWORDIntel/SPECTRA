---
id: 'int8-acceleration'
title: 'INT8 Neural Acceleration'
sidebar_position: 8
description: 'High-performance INT8 neural acceleration for real-time intelligence'
tags: ['int8', 'acceleration', 'performance', 'features']
---
