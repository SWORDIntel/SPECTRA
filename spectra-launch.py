...
Usage:
    python3 spectra-launch.py              # Auto-launch TUI
    python3 spectra-launch.py --setup      # Run setup wizard
    python3 spectra-launch.py --cli        # Launch CLI mode
    python3 spectra-launch.py --check      # Check system status
    python3 spectra-launch.py --repair     # Repair installation
"""
...
"""
    ...
    def full_setup(self) -> bool:
        ...
        if not self.check_configuration():
            print(f"  1. Run: {Colors.WHITE}python3 spectra-launch.py --setup{Colors.NC} to configure accounts")
        print(f"  2. Run: {Colors.WHITE}python3 spectra-launch.py{Colors.NC} to start SPECTRA TUI")
        print(f"  3. Or run: {Colors.WHITE}python3 spectra-launch.py --cli{Colors.NC} for CLI commands")
