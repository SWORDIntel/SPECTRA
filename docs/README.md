...
- **[Configuration & Accounts](CONFIGURATION.md)**: Setting up Telegram MTProto API credentials, multi-account pools, proxy rotation, tdata → session import, and optional Redis search cache.
