---
id: shunt-mode
title: Shunt Mode Guide
sidebar_position: 3
description: File transfer and media consolidation with advanced deduplication
tags: [shunt-mode, file-transfer, deduplication]
---
...
- [Forwarding Guide](./forwarding.md) - For message forwarding operations
- [CLI Reference](../api/cli-reference.md) - Complete CLI command reference
- [Database Schema](../reference/database-schema.md) - Understanding the deduplication database
