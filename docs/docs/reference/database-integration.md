...
sidebar_position: 2
description: Using the SPECTRA database system
tags: [database, integration, reference]
---
...
For detailed database schema information, see [Database Schema](./database-schema.md).
