...
def main():
    ...
    tests = [
        ("Python launcher help", "python3 spectra-launch.py --help"),
        ("Python launcher check", "python3 spectra-launch.py --check", [0, 1]),
        ("Splash screen check", "python3 spectra-splash.py --check"),
        ("Bash launcher help", "bash spectra.sh --help"),
        ("Bash launcher status", "bash spectra.sh --status"),
        ("File permissions", "ls -la spectra*.py spectra.sh", [0]),
    ]
