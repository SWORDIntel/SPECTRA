...
title: 'GUI Guide'
sidebar_position: 7
description: 'Graphical user interface documentation'
tags: ['gui', 'interface', 'guides']
---
...
wget https://raw.githubusercontent.com/SWORDIntel/SPECTRA/master/install-spectra.sh
...
A: Use the auto-installer: `./scripts/install/install-spectra.sh`, or manually install with pip and run `python3 -m spectra_app.spectra_gui_launcher`.
