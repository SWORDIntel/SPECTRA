...
sidebar_position: 4
description: 'Auto-launcher system setup and usage'
tags: ['launcher', 'setup', 'guides']
---
...
./scripts/install/install-spectra.sh
...
| `scripts/install/install-spectra.sh` | Linux/macOS | Enhanced installation with system deps |
...
./scripts/install/install-spectra.sh --desktop

# Force clean installation
./scripts/install/install-spectra.sh --force
```
...
./scripts/install/install-spectra.sh --prefix=/opt/spectra
...
sudo ./scripts/install/install-spectra.sh --system
